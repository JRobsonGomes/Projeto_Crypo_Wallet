class CoinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coin.save
        format.html { redirect_to @coin, notice: t('new.msg_coin_create') }
  ...
  def update
    respond_to do |format|
      if @coin.update(coin_params)
        format.html { redirect_to @coin, notice: t('editing.msg_coin_update') }
  ...
  def destroy
    @coin.destroy
    respond_to do |format|
      format.html { redirect_to coins_url, notice: t('destroy.msg_coin_destroy') }
